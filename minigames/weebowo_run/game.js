...
if (volumeSlider) {
    volumeSlider.addEventListener('input', (e) => {
        ...
        audio.mainTheme.volume = volume;
        audio.fcoTheme.volume = volume;
        audio.horseTheme.volume = volume;
        audio.powerUp.volume = volume;
        audio.coin.volume = volume;
        audio.jump.volume = volume;
        audio.hitted.volume = volume;
        audio.death.volume = volume;
    });
}
